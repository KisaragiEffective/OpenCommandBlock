 ...
 */
class TreeNode<T>(private val here: T, private val children: List<TreeNode<T>>, private val parent: TreeNode<T>?): com.kisaragieffective.opencommandblock.interfaces.MustImplementContains<T> {
