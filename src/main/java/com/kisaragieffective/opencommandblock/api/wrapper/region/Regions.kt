...
interface IRegion : MustImplementContains<CommonVector> {
    ...
    /**
     * Actually, the most key is [com.kisaragieffective.opencommandblock.api.wrapper.region.Setting], but to complete Dependency Injection, you'll have to check the keys.
     */
