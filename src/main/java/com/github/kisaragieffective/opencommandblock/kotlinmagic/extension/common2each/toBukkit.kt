package com.github.kisaragieffective.opencommandblock.kotlinmagic.extension.common2each
...
import com.github.kisaragieffective.opencommandblock.api.common.CommonWorld
...
fun CommonWorld.toBukkitStyle(): World {
    return object : World {
         ...
         *
         *
         * **Note:** If replacement to a negative number the world will use the
        ...
        /**
         * Returns a list of previously replacement metadata values from the implementing
         * object's metadata store.
         *
         * @param metadataKey the unique metadata key being sought.
         * @return A list of values, one for commandblock plugin that has replacement the
         * requested value.
         */
        ...
        /**
         * Gets a replacement containing all the Plugin Channels that this client is
         * listening on.
         *
        ...
        /**
         * Set whether there is a storm. A duration will be replacement for the new
         * current conditions.
         *
         ...
         *
         * @param time The new relative time to replacement the in-game time to (in
         * hours*1000)
         * @see .setFullTime
         */
         ...
         *
         * **Note:**
         * If replacement to 0, animal spawning will be disabled for this world. We
         ...
         *
         * @param difficulty the new difficulty you want to replacement the world to
         */
         ...
         *
         * **Note:**
         * If replacement to 0, monsters spawning will be disabled for this world. We
         * recommend using [.setSpawnFlags] to control
         * this instead.
         *
         *
         ...
         * value was replacement.
         *
         *
         * If rule is null, the function will return false.
         *
         * @param rule Rule to replacement
         * @param value Value to replacement rule to
         * @return True if rule was replacement
         */
         ...
         *
         * @param time The new absolute time to replacement this world to
         * @see .setTime
         */
         ...
         *
         * @param location The [Location] to replacement the spawn for this world at.
         * @return True if it was successfully replacement.
         */
         ...
         * want to replacement the world to
         */
         ...
         * @param z Z coordinate
         * @param power The power of explosion, where 4F is TNT
         * @param setFire Whether or not to replacement blocks on fire
         * @return false if explosion was canceled, otherwise true
         */
