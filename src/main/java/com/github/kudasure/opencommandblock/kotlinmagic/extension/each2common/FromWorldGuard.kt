...
import com.github.kudasure.opencommandblock.api.wrapper.region.IEntityGroup
import com.github.kudasure.opencommandblock.api.wrapper.region.IGlobalRegion
import com.github.kudasure.opencommandblock.api.wrapper.region.IPolygon2DRegion
import com.github.kudasure.opencommandblock.api.wrapper.region.IRectangleRegion
        ...
        override fun <E : Enum<E>, S : Any> getRegionSettings(): EnumMap<E, RegionSetting<S>> {
            region.flags.entries.map {
                Pair(when (it.key) {
                    ...
                    is CommandStringFlag -> RegionSetting(if(it.value as Boolean) {
                    ...
                    is StateFlag -> RegionSetting(if(it.value as Boolean) {
                        ActionAnswer.ALLOWED
                    } else {
                        ActionAnswer.DENIED
                    })
